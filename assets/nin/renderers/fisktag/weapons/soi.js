...
function init(renderer) {
    model = utils.createModel(renderer,"nin:shuriken_single", null, "base");
    model.bindAnimation("nin:shurikenthrowanim").setData((entity, data) => {
        if (cancelAnimations) {
			data.load(0);
            return;
        }
